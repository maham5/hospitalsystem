...
function Patientregister() {
  ...
  return (
    <div className='flex justify-center items-center my-20'>
      ...
      <button
 className=' bg-blue-700 p-4 text-white   rounded-full shadow-xl shadow-blue-400/50 hover:translate-y-3 hover:transform hover:duration-500'
onClick={()=>naviagte(-1)}>
             <svg 
        ...
        <h1 className='font-bold mb-4 mt-6 text-3xl'>Register Yourself First</h1>
